...
(`configured limit − today's completed new-word count`). In mixed mode, split **that
...
Applies in mixed mode when the deck manifest (`server/decks/mandarin-decks-v1.json`) is
