...
3. [TASKS.md](../TASKS.md) — live stability frontier and work queue
...
| --- | --- | --- |
| **Current operating contract** | `STABILITY_FRONTIER.md`, live frontier in `TASKS.md` | Understanding what the current build wave may assume, what remains blocking, and when human guidance is required |
...
- [TASKS.md](../TASKS.md) — live stability frontier and universal work queue
