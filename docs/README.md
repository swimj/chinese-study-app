...
3. [TASKS.md](../TASKS.md) — versioned stability-frontier snapshot and work catalog
4. [SPECS/README.md](../SPECS/README.md) — product spec index
...
| --- | --- | --- |
| **Current operating contract** | `STABILITY_FRONTIER.md`, frontier snapshot in `TASKS.md` | Understanding what the current build wave may assume, what remains blocking, and when human guidance is required |
...
- [TASKS.md](../TASKS.md) — versioned stability-frontier snapshot and work catalog; not live execution or review state
