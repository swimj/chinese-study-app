...
export function createScopedContentCompatibilityViews(): void {
...
function installContrastContentViews(): void {
  ...
  getDb().exec(`
    ...
    CREATE VIEW contrast_prompts AS
    ...
    CREATE TRIGGER contrast_clusters_scoped_insert
    ...
    CREATE TRIGGER contrast_clusters_scoped_update
    ...
    CREATE TRIGGER contrast_clusters_scoped_delete
    ...
    CREATE TRIGGER contrast_cluster_members_scoped_insert
    ...
    CREATE TRIGGER contrast_cluster_members_scoped_update
    ...
    CREATE TRIGGER contrast_cluster_members_scoped_delete
    ...
    CREATE TRIGGER contrast_prompts_scoped_insert
    ...
    CREATE TRIGGER contrast_prompts_scoped_update
    ...
    CREATE TRIGGER contrast_prompts_scoped_delete
...
function installProductionContentViews(): void {
  ...
  getDb().exec(`
    ...
    CREATE VIEW production_cue_accepted_words AS
    ...
    CREATE TRIGGER production_cues_scoped_insert
    ...
    CREATE TRIGGER production_cue_supplements_scoped_insert
    ...
    CREATE TRIGGER production_cue_accepted_words_scoped_insert
    ...
    CREATE TRIGGER production_cue_accepted_words_scoped_delete
