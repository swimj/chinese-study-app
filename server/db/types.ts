...
export type ContrastCandidateIntakeSource = ContrastCandidateIntake;
...
export type ContrastIntakeGroupsPayload = {
  groups: ContrastIntakeGroup[];
};

export type ContrastIntakeWordSelector = {
  targetWordId: string;
};

export type ContrastIntakeGroupSelector = ContrastIntakeWordSelector & {
  candidateText?: string | null;
  matchedWordId?: string | null;
};
...
export type ContrastIntakeWordsPayload = {
  words: ContrastIntakeWord[];
};

export type ContrastIntakePromptInput = {
  targetWordId: string;
  promptText: string;
  explanation?: string;
};

export type CreateContrastIntakeClusterInput = ContrastIntakeGroupSelector & {
...
export type AddContrastIntakeToClusterInput = ContrastIntakeGroupSelector & {
  clusterId: string;
  resolvedCandidateWordId: string;
  extraMemberWordIds?: string[];
  targetNuanceNote?: string;
...
export type AddContrastIntakePromptInput = ContrastIntakeGroupSelector & {
  clusterId: string;
  prompt: ContrastIntakePromptInput;
};
