...
export type StudyCommitCorrelation = {
...
export type StudyCommitFailureDiagnostic = {
  ...
  correlation: StudyCommitCorrelation;
  request: {
 ...
 * sidecar beside app.db. Recording failures are intentionally allowed to throw.
 */
