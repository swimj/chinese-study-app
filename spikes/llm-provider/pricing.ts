...
// Current estimate, separate from raw artifacts. Luna/Terra rates verified
// 2026-09-02 against OpenAI's pricing page (2026-07-30 list, not Sol promo).
const pricingByModel: Readonly<Record<string, ModelTokenPricing>> = {
  'gpt-5.6-terra-high': { inputPerMillionUsd: 2, cachedInputPerMillionUsd: 0.2, cacheWriteInputPerMillionUsd: 2.5, outputPerMillionUsd: 12 },
  'gpt-5.6-terra-xhigh': { inputPerMillionUsd: 2, cachedInputPerMillionUsd: 0.2, cacheWriteInputPerMillionUsd: 2.5, outputPerMillionUsd: 12 },
  'gpt-5.6-terra-max': { inputPerMillionUsd: 2, cachedInputPerMillionUsd: 0.2, cacheWriteInputPerMillionUsd: 2.5, outputPerMillionUsd: 12 },
  'gpt-5.6-luna-high': { inputPerMillionUsd: 0.2, cachedInputPerMillionUsd: 0.02, cacheWriteInputPerMillionUsd: 0.25, outputPerMillionUsd: 1.2 },
  'gpt-5.6-luna-xhigh': { inputPerMillionUsd: 0.2, cachedInputPerMillionUsd: 0.02, cacheWriteInputPerMillionUsd: 0.25, outputPerMillionUsd: 1.2 },
  'gpt-5.6-luna-max': { inputPerMillionUsd: 0.2, cachedInputPerMillionUsd: 0.02, cacheWriteInputPerMillionUsd: 0.25, outputPerMillionUsd: 1.2 },
  ...
  'glm-5.3-flash-high': { inputPerMillionUsd: 0.15, cachedInputPerMillionUsd: 0.03, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 0.5 },
  'glm-5.3-flash-max': { inputPerMillionUsd: 0.15, cachedInputPerMillionUsd: 0.03, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 0.5 },
  'glm-5.3-high': { inputPerMillionUsd: 1.4, cachedInputPerMillionUsd: 0.26, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 4.4 },
  'glm-5.3-max': { inputPerMillionUsd: 1.4, cachedInputPerMillionUsd: 0.26, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 4.4 },
  ...
  'gpt-5.6-terra': { inputPerMillionUsd: 2, cachedInputPerMillionUsd: 0.2, cacheWriteInputPerMillionUsd: 2.5, outputPerMillionUsd: 12 },
  'gpt-5.6-luna': { inputPerMillionUsd: 0.2, cachedInputPerMillionUsd: 0.02, cacheWriteInputPerMillionUsd: 0.25, outputPerMillionUsd: 1.2 },
  ...
  'glm-5.3-flash': { inputPerMillionUsd: 0.15, cachedInputPerMillionUsd: 0.03, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 0.5 },
  'glm-5.3': { inputPerMillionUsd: 1.4, cachedInputPerMillionUsd: 0.26, cacheWriteInputPerMillionUsd: null, outputPerMillionUsd: 4.4 },
